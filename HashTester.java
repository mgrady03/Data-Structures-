...
public class HashTester
{
	public static void main(String[] args) throws Exception
	{
		...
		boolean AllAddsSucceed = true; // they SHOULD all succeed   ********works
		while (infile.ready())
		{
		...
		boolean AllAddsFail = true;  // they SHOULD all fail  *************doesnt work!!!!
		while (infile.ready())
			if ( hset.add(infile.readLine()) )
		...
		boolean AllRemovesSucceed = true; // they SHOULD all succeed    **************doesnt work
		infile = new BufferedReader(new FileReader(infileName));
		while (infile.ready())
		{
		...
		infile = new BufferedReader(new FileReader(infileName));
		boolean AllRemovesFail = true;//****************works
		while (infile.ready())
			if ( hset.remove(infile.readLine()) )
